...
# Fonction pour calculer le nombre du filtres du générateur en fonction de bdd.
...
if __name__ == "__main__":
    ...
    #cols_to_remove_1 = [i for i in range(40)][:14]
    #cols_to_remove_2 = [[i for i in range(40)][:-13][0]] + [i for i in range(40)][:-13][-13:]
    #cols_to_remove_3 = [[i for i in range(40)][:-13][0]] + [i for i in range(40)][-13:]
    ...
    #cols_to_remove_1 = [i for i in range(50)][0:10] + [i for i in range(50)][30:40] #arm
    #cols_to_remove_2 = [i for i in range(50)][10:20] #chest
    #cols_to_remove_3 = [i for i in range(50)][20:30] + [i for i in range(50)][40:50] #ankle
    ...
    cols_to_remove = cols_to_remove_0
    print("Columns are:")
